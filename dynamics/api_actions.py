...
from .typing import Any, Dict, DynamicsClientPostResponse, List, Literal, Optional, Self, Type
...
class Actions:
    ...
    def __get__(self, instance: "BaseDynamicsClient", owner: Type["BaseDynamicsClient"]) -> Self:
        if instance is None:
            msg = "Actions can only be used on DynamicsClient instances."
            raise RuntimeError(msg)

        self.client = instance
        return self

    def send_email_from_template(  # noqa: PLR0913
        self,
        template_id: str,
        context_table: str,
        context_row_id: str,
        ...
        **kwargs: Any,
        ...
        def add_parties(parties_list: List[str], party_type: Literal[1, 2, 3, 4]) -> List[Dict[str, str]]:
            # Party Types:
    ...
    def convert_quote_to_order(self, quote_id: str, select: List[str] = None, **kwargs: Any) -> Dict[str, Any]:
        """
    ...
    def activate_quote(self, quote_id: str, select: List[str] = None, **kwargs: Any) -> Dict[str, Any]:
        """
    ...
    def win_quote(self, quote_id: str, **kwargs: Any) -> None:
        """
    ...
    def close_quote(self, quote_id: str, **kwargs: Any) -> None:
        """
    ...
    def revise_quote(self, quote_id: str, select: List[str] = None, **kwargs: Any) -> Dict[str, Any]:
        """
    ...
    def delete_quote(self, quote_id: str, **kwargs: Any) -> None:
        """
        Delete a quote.
    ...
    def cancel_order(self, order_id: str, reason: Optional[int] = None, **kwargs: Any) -> None:
        """
    ...
    def delete_order(self, order_id: str, **kwargs: Any) -> None:
        """
        Delete an order.
    ...
    def calculate_quote_price(self, quote_id: str, **kwargs: Any) -> None:
        """
