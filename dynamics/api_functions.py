...
class Functions:
    ...
    def __get__(self, instance: "DynamicsClient", owner: Type["DynamicsClient"]) -> Self:
        if instance is None:
            msg = "Functions can only be used on DynamicsClient instances."
            raise RuntimeError(msg)

        self.client: "DynamicsClient" = instance
        return self

    def expand_calendar(self, start: str, end: str, **kwargs: Any) -> List[Dict[str, Any]]:
    ...
    def get_default_price_level(self, **kwargs: Any) -> List[Dict[str, Any]]:
        """
    ...
    def get_valid_many_to_many(self, **kwargs: Any) -> List[Dict[str, Any]]:
    ...
    def get_valid_referenced_entities(self, name: str, **kwargs: Any) -> List[Dict[str, Any]]:
        """
    ...
    def get_valid_referencing_entities(self, name: str, **kwargs: Any) -> List[Dict[str, Any]]:
        """
    ...
    def retrieve_duplicates(self, table: str, row_id: str, entity_name: str, **kwargs: Any) -> List[Dict[str, Any]]:
    ...
    def whoami(self, **kwargs: Any) -> List[Dict[str, Any]]:
        """
